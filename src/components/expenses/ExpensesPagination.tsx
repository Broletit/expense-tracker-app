...
export default function ExpensesPagination({ total, page, pageSize, onPage, onLimit }:{
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        <button className="px-2 py-1 rounded border hover:bg-gray-100 disabled:opacity-50"
        ...
        <select className="border rounded px-2 py-1 bg-white"
          value={pageSize} onChange={(e)=>onLimit(Number(e.target.value))}>
